from dharitri_py_sdk.account_management.account_controller import (
...
class TestAccountTransactionsFactory:
    ...
    def test_save_key_value(self):
        ...
        assert tx.sender.to_bech32() == "drt1c7pyyq2yaq5k7atn9z6qn5qkxwlc6zwc4vg7uuxn9ssy7evfh5jq4nm79l"
        assert tx.receiver.to_bech32() == "drt1c7pyyq2yaq5k7atn9z6qn5qkxwlc6zwc4vg7uuxn9ssy7evfh5jq4nm79l"
