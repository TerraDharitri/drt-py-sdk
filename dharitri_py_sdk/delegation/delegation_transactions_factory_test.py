...
class TestDelegationTransactionsFactory:
    ...
    def test_create_transaction_for_adding_nodes(self):
        ...
        assert transaction.sender.to_bech32() == "drt18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqfgxqg5"
        assert transaction.receiver.to_bech32() == "drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqtllllls9xvrzw"
        assert transaction.data
        assert (
            transaction.data.decode()
            == "addNodes@e7beaa95b3877f47348df4dd1cb578a4f7cabf7a20bfeefe5cdd263878ff132b765e04fef6f40c93512b666c47ed7719b8902f6c922c04247989b7137e837cc81a62e54712471c97a2ddab75aa9c2f58f813ed4c0fa722bde0ab718bff382208@9d194282af5d5902e0a9ec824cee43e085d7967791173520b7424f79054e3f7ed13ad684fd223a691888449f34efd48b"
        )
