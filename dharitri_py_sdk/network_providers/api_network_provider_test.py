...
from dharitri_py_sdk.network_providers.http_resources import account_from_api_response
...
class TestApi:
    ...
    def test_get_network_status(self):
        result = self.api.get_network_status()
    ...
    def test_get_latest_block(self):
        result = self.api.get_latest_block()
        assert result

    def test_get_account(self):
        address = Address.new_from_bech32("drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp")
        result = self.api.get_account(address)

        assert result.address.to_bech32() == "drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp"
        assert not result.username
        assert result.contract_owner_address is None

        address = Address.new_from_bech32("drt1qqqqqqqqqqqqqpgq076flgeualrdu5jyyj60snvrh7zu4qrg05vqy7r36d")
        result = self.api.get_account(address)

        assert result.address.to_bech32() == "drt1qqqqqqqqqqqqqpgq076flgeualrdu5jyyj60snvrh7zu4qrg05vqy7r36d"
        assert not result.username
    ...
    def test_get_account_storage(self):
        address = Address.new_from_bech32("drt1qqqqqqqqqqqqqpgq076flgeualrdu5jyyj60snvrh7zu4qrg05vqy7r36d")
        result = self.api.get_account_storage(address)
    ...
    def test_get_account_storage_entry(self):
        address = Address.new_from_bech32("drt1qqqqqqqqqqqqqpgq076flgeualrdu5jyyj60snvrh7zu4qrg05vqy7r36d")
        result = self.api.get_account_storage_entry(address=address, entry_key="sum")
    ...
    def test_send_transaction(self):
        transaction = Transaction(
            sender=Address.new_from_bech32("drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp"),
            receiver=Address.new_from_bech32("drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp"),
            gas_limit=50000,
            chain_id="D",
    ...
    def test_send_transaction_with_data(self):
        ...
        assert self.api.send_transaction(transaction) == bytes.fromhex(expected_hash)
    ...
    def test_send_transactions(self):
        ...
        num_txs, hashes = self.api.send_transactions(transactions)
        assert num_txs == 2
    ...
    def test_simulate_transaction(self):
        ...
        transaction = Transaction(
            sender=Address.new_from_bech32(bob.label),
            receiver=Address.new_from_bech32("drt1qqqqqqqqqqqqqpgq076flgeualrdu5jyyj60snvrh7zu4qrg05vqy7r36d"),
            gas_limit=10000000,
            chain_id="D",
            data=b"add@07",
            nonce=nonce,
        ...
        assert (
            tx_on_network.smart_contract_results[0].sender.to_bech32()
    ...
    def test_estimate_transaction_cost(self):
        ...
        transaction.nonce = self.api.get_account(Address.new_from_bech32(bob.label)).nonce
        transaction.signature = bob.secret_key.sign(tx_computer.compute_bytes_for_signing(transaction))

        result = self.api.estimate_transaction_cost(transaction)
    ...
    def test_get_transaction(self):
        ...
        assert result.sender.to_bech32() == "drt18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqfgxqg5"
        assert result.receiver.to_bech32() == "drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp"
    ...
    def test_send_and_await_for_completed_transaction(self):
        ...
        transaction = Transaction(
            sender=Address.new_from_bech32(bob.label),
            receiver=Address.new_from_bech32("drt1qqqqqqqqqqqqqpgqhdqz9j3zgpl8fg2z0jzx9n605gwxx4djd8ss7qevxt"),
            gas_limit=5000000,
            chain_id="D",
    ...
    def test_get_token_of_account(self):
        address = Address.new_from_bech32("drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp")
        result = self.api.get_token_of_account(address, Token("TEST-ff155e"))
        ...
        assert result.token.identifier == "NFTEST-ec88b8-01"

    def test_get_fungible_tokens_of_account(self):
        address = Address.new_from_bech32("drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp")
        tokens = self.api.get_fungible_tokens_of_account(address)
        assert len(tokens)
    ...
    def test_get_non_fungible_tokens_of_account(self):
        address = Address.new_from_bech32("drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp")
        tokens = self.api.get_non_fungible_tokens_of_account(address)
        assert len(tokens)
    ...
    def test_get_definition_of_fungible_token(self):
        ...
        assert result.owner == "drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp"
        assert result.decimals == 6

    def test_get_definition_of_token_collection(self):
        result = self.api.get_definition_of_tokens_collection("NFTEST-ec88b8")
    ...
    def test_do_get_generic(self):
        query_params = {"withGuardianInfo": "true"}

        result = self.api.do_get_generic(
            "accounts/drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp",
            query_params,
        )
