...
def test_create_transaction_for_registering_and_setting_roles():
    ...
    assert transaction.receiver.to_bech32() == "drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqzlllsd5j0s2"
...
def test_set_roles_on_nft():
    ...
    assert (
        transaction.data.decode()
        == "setSpecialRole@4652414e4b2d313163653365@b20d2fc05606198c671c67e83d571ec4b9e901c1a5aea53ab9d60693abc1cfe4@444344545472616e73666572526f6c65"
    )
    assert transaction.sender == frank
    assert transaction.receiver.to_bech32() == "drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqzlllsd5j0s2"
    assert transaction.value == 0
...
def test_create_transaction_for_setting_special_role_on_semi_fungible_token():
    ...
    assert (
        transaction.data.decode()
        == "setSpecialRole@4652414e4b2d313163653365@b20d2fc05606198c671c67e83d571ec4b9e901c1a5aea53ab9d60693abc1cfe4@44434454526f6c654e4654437265617465@44434454526f6c654e46544275726e@44434454526f6c654e46544164645175616e74697479@444344545472616e73666572526f6c65"
    )
    assert transaction.sender == frank
    assert transaction.value == 0
...
def test_create_transaction_for_unsetting_special_role_on_semi_fungible_token():
    ...
    assert (
        transaction.data.decode()
        == "unSetSpecialRole@4652414e4b2d313163653365@b20d2fc05606198c671c67e83d571ec4b9e901c1a5aea53ab9d60693abc1cfe4@44434454526f6c654e46544275726e@44434454526f6c654e46544164645175616e74697479@444344545472616e73666572526f6c65"
    )
    assert transaction.sender == frank
    assert transaction.value == 0
...
def test_create_transaction_for_freezing():
    ...
    assert (
        transaction.data.decode()
        == "freeze@4652414e4b2d313163653365@b20d2fc05606198c671c67e83d571ec4b9e901c1a5aea53ab9d60693abc1cfe4"
    )
    assert transaction.sender == frank
    assert transaction.value == 0
...
def test_create_transaction_for_unfreezing():
    ...
    assert (
        transaction.data.decode()
        == "unFreeze@4652414e4b2d313163653365@b20d2fc05606198c671c67e83d571ec4b9e901c1a5aea53ab9d60693abc1cfe4"
    )
    assert transaction.sender == frank
    assert transaction.value == 0
...
def test_create_transaction_for_local_minting():
    transaction = factory.create_transaction_for_local_minting(
        sender=frank, token_identifier="FRANK-11ce3e", supply_to_mint=10
    )
...
def test_create_transaction_for_local_burning():
    transaction = factory.create_transaction_for_local_burning(
        sender=frank, token_identifier="FRANK-11ce3e", supply_to_burn=10
    )
...
def test_create_transaction_for_wiping():
    transaction = factory.create_transaction_for_wiping(sender=frank, user=grace, token_identifier="FRANK-11ce3e")

    assert transaction.data
    assert (
        transaction.data.decode()
        == "wipe@4652414e4b2d313163653365@b20d2fc05606198c671c67e83d571ec4b9e901c1a5aea53ab9d60693abc1cfe4"
    )
    assert transaction.sender == frank
    assert transaction.value == 0
...
def test_create_transaction_for_changing_to_dynamic():
    transaction = factory.create_transaction_for_changing_token_to_dynamic(sender=alice, token_identifier="TEST-123456")
...
def test_create_transaction_for_updating_token_id():
    transaction = factory.create_transaction_for_updating_token_id(sender=alice, token_identifier="TEST-123456")
...
def test_transfer_ownership():
    transaction = factory.create_transaction_for_transferring_ownership(
        sender=alice, token_identifier="AND-1d56f2", new_owner=frank
    )
...
def test_create_transaction_for_freezing_single_nft():
    transaction = factory.create_transaction_for_freezing_single_nft(
        sender=alice, token_identifier="TEST-123456", token_nonce=1, user=frank
    )
...
def test_create_transaction_for_transferring_nft_create_role():
    ...
    assert (
        transaction.data.decode()
        == "transferNFTCreateRole@5346542d313233343536@c782420144e8296f757328b409d01633bf8d09d8ab11ee70d32c204f6589bd24@798381ab00e34acde815e992cd5736d46de311c9c10e22483e0b0d1b0eb8983e"
    )
    assert transaction.sender == alice
    assert transaction.receiver.to_bech32() == "drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqzlllsd5j0s2"
    assert transaction.value == 0
...
def test_create_transaction_for_stopping_nft_creation():
    transaction = factory.create_transaction_for_stopping_nft_creation(sender=alice, token_identifier="SFT-123456")
