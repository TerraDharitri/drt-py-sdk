...
from dharitri_py_sdk.native_auth.config import NativeAuthClientConfig
...
class TestNativeAuthClient:
    ADDRESS = Address.new_from_bech32("drt1qnk2vmuqywfqtdnkmauvpm8ls0xh00k8xeupuaf6cm6cd4rx89qqlnkztp")
...
class TestNativeAuthClientWithGateway:
    ...
    def test_latest_block_should_return_signable_token(self, mocker: Any):
        responses = [
            {
                "code": 200,
                "response": {"data": {"status": {"drt_current_round": self.LATEST_ROUND}}},
            },
            {
                "code": 200,
