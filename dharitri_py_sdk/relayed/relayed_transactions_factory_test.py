...
from dharitri_py_sdk.core import Address, Transaction, TransactionComputer
from dharitri_py_sdk.core.transactions_factory_config import TransactionsFactoryConfig
from dharitri_py_sdk.relayed.errors import InvalidInnerTransactionError
from dharitri_py_sdk.relayed.relayed_transactions_factory import (
...
class TestRelayedTransactionsFactory:
    ...
    def test_create_relayed_v1_with_invalid_inner_tx(self):
        ...
        inner_transaction = Transaction(
            ...
            receiver=Address.new_from_bech32("drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqzlllsd5j0s2"),
            gas_limit=10000000,
        ...
        with pytest.raises(
            ...
            match="The gas limit is not set for the inner transaction",
        ):
            self.factory.create_relayed_v1_transaction(
                inner_transaction=inner_transaction,
                relayer_address=Address.from_bech32(self.wallets["bob"].label),
    ...
    def test_create_relayed_v1_transaction(self):
        ...
        assert (
            relayed_transaction.data.decode()
    ...
    def test_compute_relayed_v1_with_guarded_inner_tx(self):
        ...
        inner_transaction = Transaction(
            sender=Address.new_from_bech32(bob.label),
            receiver=Address.new_from_bech32("drt1qqqqqqqqqqqqqpgq54tsxmej537z9leghvp69hfu4f8gg5eu396q6dlssu"),
            gas_limit=60000000,
            chain_id=self.config.chain_id,
            data=b"getContractConfig",
            nonce=198,
    ...
    def test_create_relayed_v2_with_invalid_inner_tx(self):
        ...
        with pytest.raises(
            InvalidInnerTransactionError,
            match="The gas limit should not be set for the inner transaction",
        ):
