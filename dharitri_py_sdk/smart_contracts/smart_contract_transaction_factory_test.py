...
class TestSmartContractTransactionsFactory:
    ...
    def test_create_transaction_for_deploy(self):
        ...
        with pytest.raises(
            ...
            match="Unable to encode arguments: unsupported format or missing ABI file",
        ):
    ...
    def test_create_transaction_for_execute_no_transfer(self):
        ...
        assert (
            ...
            == "drt1qqqqqqqqqqqqqpgqhy6nl6zq07rnzry8uyh6rtyq0uzgtk3e69fq4h4xut"
        )
        assert transaction_with_typed.gas_limit == gas_limit
    ...
    def test_create_transaction_for_execute_and_transfer_rewa_as_single_token_tranfer(self):
        ...
        assert (
            ...
            == "MultiDCDTNFTTransfer@00000000000000000500b9353fe8407f87310c87e12fa1ac807f0485da39d152@01@524557412d303030303030@@0a@64756d6d79@07"
        )
        assert transaction.value == 0
    ...
    def test_create_transaction_for_execute_and_send_native_and_nfts(self):
        ...
        assert (
            transaction.data.decode()
            == "MultiDCDTNFTTransfer@00000000000000000500b9353fe8407f87310c87e12fa1ac807f0485da39d152@03@4e46542d313233343536@01@01@4e46542d313233343536@2a@01@524557412d303030303030@@0de0b6b3a7640000@64756d6d79@07"
        )
        assert transaction.value == 0
