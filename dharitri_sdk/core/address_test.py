...
def test_address_factory():
    ...
    factory_erd = AddressFactory("drt")
    ...
    assert factory_erd.create_from_public_key(pubkey).to_bech32() == "drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf"
