...
from dharitri_sdk.core.serializer import arg_to_string
from dharitri_sdk.core.transaction import Transaction
from dharitri_sdk.core.transactions_factories.transaction_builder import \
    TransactionBuilder
...
class IConfig(Protocol):
    ...
    gas_limit_dcdt_modify_royalties: int
    gas_limit_dcdt_modify_creator: int
    gas_limit_dcdt_metadata_update: int
...
Once the token is registered, you can unset this role by calling "unsetBurnRoleGlobally" (in a separate transaction).""")
    ...
    def create_transaction_for_unsetting_special_role_on_fungible_token(
        ...
        remove_role_dcdt_transfer_role: bool
    ) -> Transaction:
        parts: list[str] = [
            "unSetSpecialRole",
            arg_to_string(token_identifier),
            user.to_hex(),
            *([arg_to_string("DCDTRoleLocalMint")] if remove_role_local_mint else []),
            *([arg_to_string("DCDTRoleLocalBurn")] if remove_role_local_burn else []),
            *([arg_to_string("DCDTTransferRole")] if remove_role_dcdt_transfer_role else [])
        ]
    ...
    def create_transaction_for_setting_special_role_on_semi_fungible_token(
        ...
        parts: list[str] = [
            ...
            *([arg_to_string("DCDTTransferRole")] if add_role_dcdt_transfer_role else []),
            *([arg_to_string("DCDTRoleNFTUpdate")] if add_role_nft_update else []),
            *([arg_to_string("DCDTRoleModifyRoyalties")] if add_role_dcdt_modify_royalties else []),
            *([arg_to_string("DCDTRoleSetNewURI")] if add_role_dcdt_set_new_uri else []),
            *([arg_to_string("DCDTRoleModifyCreator")] if add_role_dcdt_modify_creator else []),
            *([arg_to_string("DCDTRoleNFTRecreate")] if add_role_nft_recreate else []),
        ]
    ...
    def create_transaction_for_unsetting_special_role_on_semi_fungible_token(
        ...
        parts: list[str] = [
            ...
            arg_to_string(token_identifier),
            user.to_hex(),
            *([arg_to_string("DCDTRoleNFTBurn")] if remove_role_nft_burn else []),
            *([arg_to_string("DCDTRoleNFTAddQuantity")] if remove_role_nft_add_quantity else []),
            *([arg_to_string("DCDTTransferRole")] if remove_role_dcdt_transfer_role else []),
            *([arg_to_string("DCDTRoleNFTUpdate")] if remove_role_nft_update else []),
            *([arg_to_string("DCDTRoleModifyRoyalties")] if remove_role_dcdt_modify_royalties else []),
            *([arg_to_string("DCDTRoleSetNewURI")] if remove_role_dcdt_set_new_uri else []),
            *([arg_to_string("DCDTRoleModifyCreator")] if remove_role_dcdt_modify_creator else []),
            *([arg_to_string("DCDTRoleNFTRecreate")] if remove_role_nft_recreate else []),
        ]
    ...
    def create_transaction_for_unsetting_special_role_on_non_fungible_token(
        ...
        parts: list[str] = [
            ...
            user.to_hex(),
            *([arg_to_string("DCDTRoleNFTBurn")] if remove_role_nft_burn else []),
            *([arg_to_string("DCDTRoleNFTUpdateAttributes")] if remove_role_nft_update_attributes else []),
            *([arg_to_string("DCDTRoleNFTAddURI")] if remove_role_nft_remove_uri else []),
            *([arg_to_string("DCDTTransferRole")] if remove_role_dcdt_transfer_role else []),
            *([arg_to_string("DCDTRoleNFTUpdate")] if remove_role_nft_update else []),
            *([arg_to_string("DCDTRoleModifyRoyalties")] if remove_role_dcdt_modify_royalties else []),
            *([arg_to_string("DCDTRoleSetNewURI")] if remove_role_dcdt_set_new_uri else []),
