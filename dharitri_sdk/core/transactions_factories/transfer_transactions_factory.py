...
from dharitri_sdk.core.tokens import TokenComputer, TokenTransfer
from dharitri_sdk.core.transaction import Transaction
from dharitri_sdk.core.transactions_factories.token_transfers_data_builder import \
...
class IConfig(Protocol):
    ...
    gas_limit_dcdt_transfer: int
    gas_limit_dcdt_nft_transfer: int
    gas_limit_multi_dcdt_nft_transfer: int
...
class TransferTransactionsFactory:
    ...
    def create_transaction_for_dcdt_token_transfer(self,
                                                   sender: IAddress,
                                                   receiver: IAddress,
    ...
    def _multi_transfer(self,
        ...
        gas = self.config.gas_limit_multi_dcdt_nft_transfer * len(token_transfers) + ADDITIONAL_GAS_FOR_DCDT_NFT_TRANSFER
        return data_parts, gas, sender
