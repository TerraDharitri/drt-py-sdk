...
from dharitri_sdk.network_providers.api_network_provider import \
    ApiNetworkProvider
...
from dharitri_sdk.network_providers.interface import IPagination
from dharitri_sdk.network_providers.proxy_network_provider import ContractQuery
...
class TestApi:
    ...
    def test_get_network_gas_configs(self):
        ...
        assert built_in_cost["DCDTTransfer"] == 200000
    ...
    def test_get_account(self):
        ...
        address = Address.new_from_bech32('drt1qqqqqqqqqqqqqpgqws44xjx2t056nn79fn29q0rjwfrd3m43396qzdr496')
        result = self.api.get_account(address)
    ...
    def test_get_meta_dcdt(self):
        adr = Address.new_from_bech32('drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp')
    ...
    def test_query_contract(self):
        query = ContractQuery(Address.new_from_bech32('drt1qqqqqqqqqqqqqpgqqy34h7he2ya6qcagqre7ur7cc65vt0mxrc8qwq64qt'),
                              'getSum', 0, [])
    ...
    def test_get_definition_of_fungible_token(self):
        ...
        assert result.identifier == 'TEST-ff155e'
        assert result.owner.to_bech32() == 'drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp'
    ...
    def test_get_non_fungible_token(self):
        ...
        assert result.identifier == 'NFTEST-ec88b8-01'
        assert result.collection == 'NFTEST-ec88b8'
        assert result.creator.to_bech32() == 'drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp'
        assert result.balance == 0
        assert result.royalties == 25
    ...
    def test_send_transaction(self):
        transaction = Transaction(
            sender="drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp",
            receiver="drt1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qq70mmp",
            gas_limit=50000,
            chain_id="D",
